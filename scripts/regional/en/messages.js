...
Regional.messages['en'] = {
	...
	"TEXT_SQUARES_USED":"Post size in squares:",
	...
	"TEXT_PAY_BY_CARD":"Pay by Debit/Credit Card",
    ...
    "TEXT_SMS_NOTICE":"*The successful delivery of text message notifications depends on the coverage of Twilio's service. Please check their page for more information.",
	//FAQ
	"FAQ":{
		"?WHAT_IS_WOL":"What is The Wall of Love?",
		"WHAT_IS_WOL":"WoL is an online interactive Wall of love, divided into small squares. It will be infinite and it can only grow bigger and bigger. You can always scroll and look at the Wall, get inspired and spread the 'wove'.<br><br>People can pay one pound for the size of 1 square, and respectively more if they want to occupy bigger area. Each image has a caption/description that later can be searched for using the search function.<br><br>The Wall can be zoomed in, zoomed out, navigated through, thus changing the way you view it.<br>See our Legend for more information. ",
		...
		"REGISTER":"Users don’t have to register. They simply have to click the 'Write now' button.",
		"?HOWPAY":"How can I pay?",
		"HOWPAY":"You can pay by text message(SMS billing), credit/debit card and PayPal.",
		...
		"HLT":"Usually it takes a few seconds, sometimes it might be up to a minute. The successful delivery of text message notifications depends on the coverage of Twilio's service. Please check their page for more information.",
		"?CONTACT":"How can I contact the support team?",
		"CONTACT":"You can contact us using the 'Contact Us' form or by email: service@thewalloflove.net",
