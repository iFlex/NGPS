...
function test_move()
{
	...
	var div2 = new container({width:400,height:300,x:400,y:0,background:"green",border_size:1,border_style:"solid",border_color:"0x000000",border_radius:["15px"]});
	success = div2.load();
...
function test_leaf()
{
	var div = new container({width:300,height:300,x:250,y:100,border_size:1,border_style:"solid",border_color:"0x000000",border_radius:[25]});
	success = div.load();
